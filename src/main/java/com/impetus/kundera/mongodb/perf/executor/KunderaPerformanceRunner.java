...
import com.impetus.kundera.mongodb.perf.dao.user.UserDaoFactory;
...
//	        Future  task = null;
	    ...
	    public void onBulkLoad(int rangeValue, String client)
	    {
	        ...
	        long t2 = System.currentTimeMillis();
	        System.out.println("Kundera Performance: MaxinsertUsers(" + 1 + "), total number of records(" + rangeValue + ")>>>\t" + (t2 - t1) + " client>>>" + client);
